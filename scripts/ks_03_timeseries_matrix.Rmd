...
```{r load-in}
# algae time series
algae_1982 <- read_csv(here('data', 'clean', '20220525_1982-1995_algae.csv'))
algae_1996 <- read_csv(here('data', 'clean', '20220525_1996-2006_algae.csv'))
algae_2011 <- read_csv(here('data', 'clean', '20220525_2011-end_algae.csv'))
...
```{r}
#pick the method you want for matrix based on evaluation plots above
animal_1996_matrix <- good3(animal_dataSET2)


#legendre dissimilarity matrix
coldiss(animal_1996_matrix) 

#mds
animal_1996_mds <- metaMDS(animal_1996_matrix)

plot(animal_1996_mds)
coldiss(animal_1996_matrix)
#save these as graphs for looking at later

animal_1996_matrix2 <- fortify(animal_1996_matrix)

#save(animal_matrix, file = here('data','animal_matrix-1996r.RData'))
write.csv(animal_1996_matrix2, file = here('data', 'clean', '20220128_animal_matrix_1996-1995.csv'))

png(filename = here('output', 'cluster_ks', '20220128_timeseries',
                    'animal-dissimilarity_1996-1995.png'),
    width = 1000, height = 500,
    units = 'px')
coldiss(animal_1996_matrix)
dev.off()
...
```{r}
#pick the method you want for matrix based on evaluation plots above
animal_2011_matrix <- good3(animal_dataSET2)


#legendre dissimilarity matrix
coldiss(animal_2011_matrix) 

#mds
animal_2011_mds <- metaMDS(animal_2011_matrix)

plot(animal_2011_mds)
coldiss(animal_2011_matrix)
#save these as graphs for looking at later

animal_2011_matrix2 <- fortify(animal_2011_matrix)

#save(animal_matrix, file = here('data','animal_matrix-2011r.RData'))
write.csv(animal_2011_matrix2, file = here('data', 'clean', '20220128_animal_matrix_2011-end.csv'))

png(filename = here('output', 'cluster_ks', '20220128_timeseries',
                    'animal-dissimilarity_2011-end.png'),
    width = 1000, height = 500,
    units = 'px')
coldiss(animal_2011_matrix)
dev.off()
...
for(i in 1:length(nomclustEvals)){
  ...
  EvalPlot <- plotEvals(EvalData, nomclustEvals[i])
  ggsave(EvalPlot, device = "pdf",
         filename = here('output', 'cluster_ks', '20220525_timeseries',
...
```{r}
#pick the method you want for matrix based on evaluation plots above
algae_1982_matrix <- good3(algae_dataSET2)


#legendre dissimilarity matrix
coldiss(algae_1982_matrix) 

#mds
algae_1982_mds <- metaMDS(algae_1982_matrix)

plot(algae_1982_mds)
coldiss(algae_1982_matrix)
#save these as graphs for looking at later

algae_1982_matrix2 <- fortify(algae_1982_matrix)

#save(algae_matrix, file = here('data','algae_matrix-1982r.RData'))
write.csv(algae_1982_matrix2, file = here('data', 'clean', '20220525_algae_matrix_1982-1995.csv'))

png(filename = here('output', 'cluster_ks', '20220525_timeseries',
                    'algae-dissimilarity_1982-1995.png'),
    width = 1000, height = 500,
    units = 'px')
coldiss(algae_1982_matrix)
dev.off()
...
```{r}
#pick the method you want for matrix based on evaluation plots above
algae_1996_matrix <- good3(algae_dataSET2)


#legendre dissimilarity matrix
coldiss(algae_1996_matrix) 

#mds
algae_1996_mds <- metaMDS(algae_1996_matrix)

plot(algae_1996_mds)
coldiss(algae_1996_matrix)
#save these as graphs for looking at later

algae_1996_matrix2 <- fortify(algae_1996_matrix)

#save(algae_matrix, file = here('data','algae_matrix-1996r.RData'))
write.csv(algae_1996_matrix2, file = here('data', 'clean', '20220128_algae_matrix_1996-2006.csv'))

png(filename = here('output', 'cluster_ks', '20220128_timeseries',
                    'algae-dissimilarity_1996-2006.png'),
    width = 1000, height = 500,
    units = 'px')
coldiss(algae_1996_matrix)
dev.off()
...
```{r}
#pick the method you want for matrix based on evaluation plots above
algae_2011_matrix <- good3(algae_dataSET2)


#legendre dissimilarity matrix
coldiss(algae_2011_matrix) 

#mds
algae_2011_mds <- metaMDS(algae_2011_matrix)

plot(algae_2011_mds)
coldiss(algae_2011_matrix)
#save these as graphs for looking at later

algae_2011_matrix2 <- fortify(algae_2011_matrix)

#save(algae_matrix, file = here('data','algae_matrix-2011r.RData'))
write.csv(algae_2011_matrix2, file = here('data', 'clean', '20220128_algae_matrix_2011-end.csv'))

png(filename = here('output', 'cluster_ks', '20220128_timeseries',
                    'algae-dissimilarity_2011-end.png'),
    width = 1000, height = 500,
    units = 'px')
coldiss(algae_2011_matrix)
dev.off()
