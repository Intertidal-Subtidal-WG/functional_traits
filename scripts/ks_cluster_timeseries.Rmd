...
ggsave(here('output', 'animal-cluster-dendro-2011r.png'), plot = last_plot())

# also make csv lists of animals in those years
animal_clust_l <- animal_labs %>%
  select(label, cluster)

write.csv(animal_clust_l, here('output', 'cluster_ks', 'animal-clusters-2011r.csv'))
```
...
ggsave(here('output', 'cluster_ks', 'animal-cluster-tsne_2011r.png'), plot = last_plot())
