...
EvalPlot <- plotEvals(evaluation, "AIC")
...
for(i in 1:length(nomclustEvals)){
  ...
  ggsave(EvalPlot, device = "pdf",
         filename = here('output', 'cluster_ks', paste0(nomclustEvals[i],"_plot.pdf")))
}
...
ggsave(EvalPlotPSFE, filename = here('output', 'cluster_ks', 'EvalPlotPSFE.pdf'),
       width = 9, height = 4)
...
ggsave(EvalPlotPSFM, filename = here('output', 'cluster_ks', 'EvalPlotPSFM.pdf'), 
       width = 9, height = 4)
...
ggsave(EvalPlotAIC, filename = here('output', 'cluster_ks', 'EvalPlotAIC.pdf'), 
       width = 9, height = 4)
...
ggsave(EvalPlotBIC, filename = here('output', 'cluster_ks', 'EvalPlotBIC.pdf'), 
       width = 9, height = 4)
