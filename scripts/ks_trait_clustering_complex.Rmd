...
```{r export graphs}
png(filename = here('output', 'cluster_ks', '20210830_algae-dissimilarity.png'),
...
png(filename = here('output', 'cluster_ks', '20210830_animal-dissimilarity.png'),
    width = 1000, height = 500,
    units = 'px')
coldiss(animal_matrix)
dev.off()
...
ggsave(here('output', 'cluster_ks', '20210830_animal-cluster-tsne.png'), plot = last_plot())
