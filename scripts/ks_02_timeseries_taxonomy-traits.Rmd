...
write.csv(sp_1982r_animal, here('data', 'clean', '20220128_1982-1995_animal.csv'), row.names = FALSE)
write.csv(sp_1982r_algae, here('data', 'clean', '20220128_1982-1995_algae.csv'), row.names = FALSE)
```
...
write.csv(sp_1996r_animal, here('data', 'clean', '20220128_1996-2006_animal.csv'), row.names = FALSE)
write.csv(sp_1996r_algae, here('data', 'clean', '20220128_1996-2006_algae.csv'), row.names = FALSE)
```
...
write.csv(sp_2011r_animal, here('data', 'clean', '20220128_2011-end_animal.csv'), row.names = FALSE)
write.csv(sp_2011r_algae, here('data', 'clean', '20220128_2011-end_algae.csv'), row.names = FALSE)
```
