...
animal_imp2 <- read.csv(file = here(trait,'20220312_animal_imputed.csv'))[,-1]%>% 
  mutate(across(.fns = ~ as.factor(.)))
algae_imp2 <- read.csv(file = here(trait,'20220312_algae_imputed.csv'))[,-1]%>% 
  mutate(across(.fns = ~ as.factor(.)))
...
write.csv(pc_ct_animal, here(trait, '20220314_1982-end_animal.csv'), row.names = FALSE)
write.csv(pc_ct_algae, here(trait, '20220314_1982-end_algae.csv'), row.names = FALSE)
...
write.csv(sp_1982r_animal, here('data', 'clean', '20220313_1982-1995_animal.csv'), row.names = FALSE)
write.csv(sp_1982r_algae, here('data', 'clean', '20220313_1982-1995_algae.csv'), row.names = FALSE)
```
...
write.csv(sp_1996r_animal, here('data', 'clean', '20220313_1996-2006_animal.csv'), row.names = FALSE)
write.csv(sp_1996r_algae, here('data', 'clean', '20220313_1996-2006_algae.csv'), row.names = FALSE)
```
...
write.csv(sp_2011r_algae, here('data', 'clean', '20220313_2011-end_algae.csv'), row.names = FALSE)
```
