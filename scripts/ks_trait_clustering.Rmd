...
trait_raw <- read.csv(here("data", '20220117_ShoalsFunctionalTraits.csv'), 
                      na.strings = c("","NA", 'N/A'))
...
animal_clean <- animal_raw %>% 
  ...
  mutate(across(.fns = ~ as.factor(.)))
#write_csv(algae_clean, here("data","20220117_algae_clean.csv"))
#write_csv(animal_clean, here("data","20220117_animal_clean.csv"))
```
...
write.csv(algae_imp2, file = here('data', 'clean','20220117_algae_imputed.csv'))
...
write.csv(animal_imp2, file = here('data', 'clean','20220117_animal_imputed.csv'))
