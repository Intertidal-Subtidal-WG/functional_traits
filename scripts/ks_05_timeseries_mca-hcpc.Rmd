...
fviz_mca_var(mca_algae_sheltered_end$mcares, col.var = 'cos2', alpha.var = 'contrib',
                           gradient.cols = c("#00AFBB", "#E7B800", "#FC4E07"),
...
ggsave(filename = here(plots, '20220327_algae_sheltered_change.png'), device = 'png', 
       height = 5, width = 7, units = 'in')
...
ggsave(filename = here(plots, '20220327_algae_exposed_change.png'), device = 'png', 
       height = 5, width = 7, units = 'in')
```
...
ggsave(filename = here(plots, '20220327_algae_exposed_start.png'), device = 'png', 
       height = 5, width = 7, units = 'in')
...
ggsave(filename = here(plots, '20220327_algae_exposed_mid.png'), device = 'png', 
       height = 5, width = 7, units = 'in')
...
ggsave(filename = here(plots, '20220327_algae_exposed_end.png'), device = 'png', 
       height = 5, width = 7, units = 'in')
