...
shelteredhcpc2 <- HCPC(res = mca_animal_sheltered_start$mcares, nb.clust =  4)
...
ggplot(start_test2, horiz = TRUE) + 
  ...
  ylim(.25,-.12) +
  # manually set colors
  scale_color_manual(values = c('#a08b5a','#bcbcd2','#543414','#5484c4','black')) +
  theme(axis.ticks = element_blank(),
        axis.text.y = element_blank()
        )
...
ggplot(dend_animal_sheltered_end, horiz = TRUE) + 
